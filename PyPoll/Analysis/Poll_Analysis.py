...
print(line3)                                                                                                #Prints the first part, up until the calculations            
...
for _ in Percents:                   #Runs through Percents..
    if(WinnerP == _):                #.. if max is found, set WinnerC to the index of the max..
        WinnerC = UnqCand[Percents.index(_)]       #.. basically navigates laterally through the lists to find the winner based on percents.
